...
import net.opengis.sps.x20.ReserveType;
...
public class ReserveTaskingRequest extends TaskingRequest {
    ...
    public ReserveTaskingRequest(ReserveDocument reserveDoc) {
        super(reserveDoc);
        ReserveType reserve = reserveDoc.getReserve();
        reservationExpiration = reserve.getReservationExpiration();
    }
