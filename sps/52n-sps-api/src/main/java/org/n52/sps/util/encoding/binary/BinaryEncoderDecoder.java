 ...
 */
package org.n52.sps.util.encoding.binary;
...
// TODO implement BinaryencoderDecoder
public class BinaryEncoderDecoder implements SweEncoderDecoder<Void, Void> {

    public static final String BINARY_ENCODING = "http://www.opengis.net/swe/2.0/BinaryEncoding";

    public BinaryEncoderDecoder(BinaryEncodingType binaryEncoding) {
