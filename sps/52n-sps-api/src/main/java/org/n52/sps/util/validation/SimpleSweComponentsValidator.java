...
public class SimpleSweComponentsValidator {
	...
	public VectorType validateQuantityVector(VectorType vectorTemplate, VectorType value)
	...
	public void validateAgainstInterval(double value, List<Double> interval) throws InvalidComponentException {
		...
		if (Double.compare(value, intervalBegin) <= 0 && Double.compare(value, intervalEnd) >= 0) {
			...
			errorMsg.append(value).append(" is not in range [").append(intervalBegin).append(",").append(intervalEnd)
					.append("].");
	 ...
	 * @throws InvalidComponentException
	 */
	public TextType validateString(Field textField, String value) throws InvalidComponentException {
		return validateString(getText(textField), value);
	}
	 ...
	 * @throws InvalidComponentException
	 */
	public TextType validateString(TextType textField, String value) throws InvalidComponentException {
		TextType countToSet = (TextType) textField.copy();
		countToSet.setValue(value);
		return countToSet;
	}
}
