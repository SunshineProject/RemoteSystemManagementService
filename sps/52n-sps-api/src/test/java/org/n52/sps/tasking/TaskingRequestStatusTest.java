...
public class TaskingRequestStatusTest {
    ...
    public void testGetSensorTaskStatus() {
        ...
        assertEquals(TaskingRequestStatus.PENDING, TaskingRequestStatus.getTaskingRequestStatus("Pending"));
        assertEquals(TaskingRequestStatus.REJECTED, TaskingRequestStatus.getTaskingRequestStatus("Rejected"));
    }
